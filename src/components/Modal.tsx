  ...
  return (
    <div className='h-[100vh] w-[100vw] bg-black/50 fixed top-0 left-0 flex justify-center items-center'>
      <div className='rounded-[10px] w-[689px] h-[621px] bg-white flex  '>
        <div onClick={()=>setModal(false)}  className="hover:scale-110 transform transition-transform duration-300 rounded-[100px] bg-[#FBF9F9] w-[40px] h-[40px] relative bottom-5 left-[95%] items-center flex justify-center">
